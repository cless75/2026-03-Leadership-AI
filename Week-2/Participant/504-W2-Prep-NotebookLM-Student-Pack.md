...
# Student Pack — NotebookLM неделя 2: Процессы и сотрудничество

**Мастерская:** AI Empowered Team (504)
**Неделя:** 2 — Процессы и сотрудничество (Хоукинз #3)
**Lesson-Core:** [[MS-Courses/25-CM-MDPG/504-CM-AI-Empowered-Team/Week-2/NotebookLM/Lesson-Core-W2|Lesson-Core W2]]
...
> **Полный локальный пакет W2:** [[MS-Courses/25-CM-MDPG/504-CM-AI-Empowered-Team/Week-2/NotebookLM/README|Week-2/NotebookLM/README]]
> **Порядок и приоритеты:** [[MS-Courses/25-CM-MDPG/504-CM-AI-Empowered-Team/Week-2/NotebookLM/Source-Manifest-W2|Source-Manifest-W2]]

| # | Источник | Тип | Назначение | Как загрузить |
|---|----------|-----|------------|---------------|
| 1 | **PreClass W2** (`504-W2-Prep-Flipped-PreClass-Participants`) | Нарратив | Преридинг, модели, 4 вопроса, самодиагностика 0–4 | Уже в Google Doc: `1d8oYeCqME6dK--eVKdlqXnxEIvnM4Xq4IM5rGbaedZ0` → импорт URL в NLM |
| 2 | **Script Three Layers AI** (`Source-Script-Three-Layers-AI-W2` в `Week-2/NotebookLM/`) | Нарратив | D/U/N, экзоскелет, демо AI-Диагноста, промпт | Загрузить `.md` или экспорт в GDoc (`gd:export`) |
| 3 | **S09 Value Chain** (`Source-S09-Value-Chain-W2`) | Нарратив | Цепочка ценности, 6 шагов, связь с ДЗ v2 | Загрузить `.md` из `Week-2/NotebookLM/`; альтернатива — GDoc скилла S09: `1xNhSfZBgX-ThuLskqF0_gCENDenxGqqhspEacd7DlBE` (не дублировать оба) |
| 4 | **Tuckman-Model** (канон) | Справочный | Фазы, переходы, признаки | Экспорт канона в GDoc → NLM |
| 5 | **Ideal-Team-Player** (канон) | Справочный | Humble/Hungry/Smart, антипаттерны | Экспорт в GDoc |
...
| # | Источник | Когда |
|---|----------|--------|
| 8 | **Smart-Communication-Lencioni** (канон) | Связка W1→W3, акцент на Smart |
| 9 | **Lesson-Core-W2** | Тайминг блоков и карточки для Slide Deck / сверки |
| 10 | **Skills-of-Week-W2** | Промпты и структура S05–S08 + S09 |
...
Ниже — запросы для копирования в NotebookLM Studio. **Полные** промпты Slide Deck (части 1–2), пост-аудио, пост-квиз, NLM Slide Review и практический чеклист дублируются в [[MS-Courses/25-CM-MDPG/504-CM-AI-Empowered-Team/Week-2/NotebookLM/Prompt-Pack-W2|Prompt-Pack-W2]] (v3).
...
```text
Создай Study Guide для подготовки к воркшопу "504 W2: Процессы и сотрудничество".
...
```text
Создай Post-Workshop Study Guide для "504 W2: Процессы и сотрудничество".
...
```text
Сгенерируй входной Quiz из 5 вопросов (multiple choice, 4 варианта) по теме "504 W2: Процессы и сотрудничество".
...
> **Канон для когорты:** публикация через **Google Form** (скрипт `Quiz-Scripts/504-W2-Post-Quiz-CreateForm.gs`). Промпт ниже — для черновика в NLM или сверки формулировок. Полный текст: [[MS-Courses/25-CM-MDPG/504-CM-AI-Empowered-Team/Week-2/NotebookLM/Prompt-Pack-W2|Prompt-Pack-W2]] § 7.

```text
Сгенерируй post-session Quiz из 5 вопросов (multiple choice, 4 варианта) по теме "504 W2: Процессы и сотрудничество + value chain".
...
```text
Создай 15 flashcards (вопрос-ответ) по теме "504 W2: Процессы и сотрудничество".
...
Полные сценарии (7 мин пре, 10 мин пост): [[MS-Courses/25-CM-MDPG/504-CM-AI-Empowered-Team/Week-2/NotebookLM/Prompt-Pack-W2|Prompt-Pack-W2]] § 3–4.

### 2.7 Slide Deck (две части)

Полные промпты (часть 1 — 12 слайдов, часть 2 — 10 слайдов): [[MS-Courses/25-CM-MDPG/504-CM-AI-Empowered-Team/Week-2/NotebookLM/Prompt-Pack-W2|Prompt-Pack-W2]] § 1–2. После генерации — **NLM Slide Review** (11 проверок в том же файле).

### 2.8 FAQ для участников (10 вопросов)

```text
Сгенерируй FAQ (10 вопросов и ответов) для участников недели 2 (504).
...
```text
Проведи факт-проверку материалов по W2 (Study Guide, Quiz, Flashcards, FAQ, Slides, Audio).
...
- [[MS-Courses/25-CM-MDPG/504-CM-AI-Empowered-Team/Week-2/NotebookLM/Lesson-Core-W2|Lesson-Core W2]]
- [[MS-Courses/25-CM-MDPG/504-CM-AI-Empowered-Team/Week-2/Participant/504-W2-Prep-Flipped-PreClass-Participants|PreClass для участников]]
- [[MS-Courses/25-CM-MDPG/504-CM-AI-Empowered-Team/Week-2/NotebookLM/Prompt-Pack-W2|Prompt-Pack W2]]
- [[MS-Courses/25-CM-MDPG/504-CM-AI-Empowered-Team/Week-2/NotebookLM/Upload-Checklist-W2|Upload Checklist W2]]
...
**Версия пакета участника:** v1 (2026-04-09). Согласовано с NotebookLM package **v3** (`Week-2/NotebookLM/README`).
